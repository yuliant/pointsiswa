        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"></span>&nbsp;Daftar Nama Kesiswaan dan BK</h3><span style="float:right;"><a href="<?php echo $basead; ?>addguru" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah Guru</a></span>
            </div>
            <!-- /.box-header -->
