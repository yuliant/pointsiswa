...
//prestasi
  function addprestasi($con,$c_prestasi,$nama,$username,$password){
    $akh=mysqli_query($con,"INSERT INTO prestasi set c_prestasi='$c_prestasi',nama='$nama',username='$username',password='$password' ");
    session_start();
    $_SESSION['pesan']='tambah';
    header('location:../../addprestasi');
  }
  function editprestasi($con,$c_prestasi,$nama,$username,$password){
    $akh=mysqli_query($con,"UPDATE prestasi set nama='$nama',username='$username',password='$password' where c_prestasi='$c_prestasi' ");
    session_start();
    $_SESSION['pesan']='edit';
    header('location:../../editprestasi/'.$c_prestasi.'');
  }
  function hapusprestasi($con,$c_prestasi){
    $akh=mysqli_query($con,"DELETE from pelanggaran where c_prestasi='$c_prestasi' ");
    $akh2=mysqli_query($con,"DELETE FROM chat where c_prestasi='$c_prestasi' ");
    $akh3=mysqli_query($con,"DELETE FROM relasichat where c_prestasi='$c_prestasi' ");
    $akh4=mysqli_query($con,"DELETE from prestasi where c_prestasi='$c_prestasi' ");
    session_start();
    $_SESSION['pesan']='hapus';
