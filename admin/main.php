...
if(empty($_GET['smkakh'])){
  ...
  if($act=='kategoripelanggaran' or $act=='bentukpelanggaran' or $act=='addbentukpelanggaran' or $act=='sanksipelanggaran' or $act=='addsanksi' or $act=='editsanksi'){
   ...
   else if($act=='prestasi' or $act=='addprestasi' or $act=='editprestasi'){
...
?>
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $dak; ?>>
          <a href="<?php echo $basead; ?>prestasi">
            <i class="glyphicon glyphicon-education"></i> <span>Prestasi Siswa</span>
          </a>
        </li>
        <li <?php echo $eak; ?>>
...
<?php
  if(empty($_GET['smkakh'])){require 'view/home.php';}
    ...
    if($act=='kategoripelanggaran'){
      ...
      require 'view/a-prestasi.php';
    }
    else if($act=='addprestasi'){
      require 'view/a-addprestasi.php';
    }
    else if($act=='editprestasi'){
      require 'view/a-editprestasi.php';
    }
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://www.aplikasipendidikan.net/">by SMP SEPULUH NOPEMBER SIDOARJO </a></strong>
  </footer>
  <!-- Control Sidebar -->
